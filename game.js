...
function Farmer(sprites, grid) {
  ...
  this.handleKeyDown = function(event) {
    ...
    var offX = 0, offY = 0;
    if (event.keyCode == 37 || event.keyCode == 65) offX = -1;
    if (event.keyCode == 38 || event.keyCode == 87) offY = -1;
    if (event.keyCode == 39 || event.keyCode == 68) offX = 1;
    if (event.keyCode == 40 || event.keyCode == 83) offY = 1;
